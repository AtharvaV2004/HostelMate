...
import { MapPin, Compass as Explore, Users, User, ArrowRight, Route } from 'lucide-react';
    ...
    return (
        <div className="bg-[#1A1F1D] font-display text-slate-100 min-h-screen flex flex-col relative pb-32">
            ...
            <header className="p-6 sticky top-0 z-40 bg-[#1A1F1D]/90 backdrop-blur-md border-b border-[#116364]/10">
                <h1 className="text-3xl font-black tracking-tight text-white uppercase italic">My Trips</h1>
            </header>

            <main className="flex-1 p-6 space-y-6">
                <div className="flex items-center gap-4">
                    <h3 className="text-xs font-black uppercase tracking-[0.2em] text-emerald-100/40">Past Runs</h3>
                ...
                <div className="bg-[#242A28] rounded-3xl p-8 border border-white/5 shadow-2xl text-center space-y-4">
                    <div className="size-20 mx-auto rounded-full bg-[#116364]/20 flex items-center justify-center border border-[#116364]/50">
                        <Route className="text-[#116364] w-10 h-10" />
                    </div>
                    <h3 className="text-xl font-bold text-white">Feature in Development</h3>
                    <p className="text-sm text-emerald-100/50">Soon, you'll be able to view all your past community runs, re-order frequent items, and see how much time you've saved your hostel mates.</p>
